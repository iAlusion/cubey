...
client.on('error', winston.error)
	...
	.on('ready', () => {
        ...
        .set('Authorization', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjE0ODg5OTU4NzI4Mzg3Nzg4OCIsImlhdCI6MTUwMzIyOTM3N30.ycm76YoGMWOQSdxiL6jAqpyLoGS4HphKDvDyx3cbBPg')
    ...
    snekfetch.post(`https://bots.discord.pw/api/bots/314042564909072386/stats`)
        .set('Authorization', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiIxNDg4OTk1ODcyODM4Nzc4ODgiLCJyYW5kIjo4OTksImlhdCI6MTUwMzIzMjE5N30.mqeL7s552SEf7CvWxNHQ5cQB-lsiE0M6ZnvrBLjOPNo')
        .send({ server_count: client.guilds.size })
