...
module.exports = class LaunchCybernukeCommand extends Command {
	constructor(client) {
		super(client, {
			name: 'activate-cybernuke',
			aliases: ['ac cybernuke', 'nuke'],
			group: 'administration',
			memberName: 'cybernuke',
			description: 'Bans all members that have joined recently, with new accounts.(E.g for prevention of server raids.)',
			guildOnly: true,
